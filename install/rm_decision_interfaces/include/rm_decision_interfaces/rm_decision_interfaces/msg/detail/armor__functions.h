...
#ifndef RM_DECISION_INTERFACES__MSG__DETAIL__ARMOR__FUNCTIONS_H_
#define RM_DECISION_INTERFACES__MSG__DETAIL__ARMOR__FUNCTIONS_H_
 ...
 * calls
 * rm_decision_interfaces__msg__Armor__init().
...
/**
 * It calls
 * rm_decision_interfaces__msg__Armor__fini()
 ...
 * rm_decision_interfaces__msg__Armor__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rm_decision_interfaces__msg__Armor__Sequence__fini()
 * on the array,
...
#endif  // RM_DECISION_INTERFACES__MSG__DETAIL__ARMOR__FUNCTIONS_H_
