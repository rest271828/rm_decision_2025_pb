...
#ifndef RM_DECISION_INTERFACES__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
#define RM_DECISION_INTERFACES__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
 ...
 * calls
 * rm_decision_interfaces__msg__RobotStatus__init().
...
/**
 * It calls
 * rm_decision_interfaces__msg__RobotStatus__fini()
 ...
 * rm_decision_interfaces__msg__RobotStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rm_decision_interfaces__msg__RobotStatus__Sequence__fini()
 * on the array,
...
#endif  // RM_DECISION_INTERFACES__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
