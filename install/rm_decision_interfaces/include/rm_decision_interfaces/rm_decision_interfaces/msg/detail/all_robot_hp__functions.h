...
#ifndef RM_DECISION_INTERFACES__MSG__DETAIL__ALL_ROBOT_HP__FUNCTIONS_H_
#define RM_DECISION_INTERFACES__MSG__DETAIL__ALL_ROBOT_HP__FUNCTIONS_H_
 ...
 * calls
 * rm_decision_interfaces__msg__AllRobotHP__init().
...
/**
 * It calls
 * rm_decision_interfaces__msg__AllRobotHP__fini()
 ...
 * rm_decision_interfaces__msg__AllRobotHP__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rm_decision_interfaces__msg__AllRobotHP__Sequence__fini()
 * on the array,
...
#endif  // RM_DECISION_INTERFACES__MSG__DETAIL__ALL_ROBOT_HP__FUNCTIONS_H_
