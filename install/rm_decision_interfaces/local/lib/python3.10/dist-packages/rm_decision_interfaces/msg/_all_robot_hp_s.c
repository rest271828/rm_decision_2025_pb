...
bool rm_decision_interfaces__msg__all_robot_hp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_decision_interfaces.msg._all_robot_hp.AllRobotHP", full_classname_dest, 51) == 0);
  }
  rm_decision_interfaces__msg__AllRobotHP * ros_message = _ros_message;
  {  // red_1_robot_hp
...
{
  /* NOTE(esteve): Call constructor of AllRobotHP */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_decision_interfaces.msg._all_robot_hp");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AllRobotHP");
