...
bool pb_rm_interfaces__msg__game_robot_hp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pb_rm_interfaces.msg._game_robot_hp.GameRobotHP", full_classname_dest, 47) == 0);
  }
  pb_rm_interfaces__msg__GameRobotHP * ros_message = _ros_message;
  {  // red_1_robot_hp
...
PyObject * pb_rm_interfaces__msg__game_robot_hp__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pb_rm_interfaces.msg._game_robot_hp");
