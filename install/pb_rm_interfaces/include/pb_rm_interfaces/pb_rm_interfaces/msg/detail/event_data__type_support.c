...
static rosidl_typesupport_introspection_c__MessageMember pb_rm_interfaces__msg__EventData__rosidl_typesupport_introspection_c__EventData_message_member_array[8] = {
  {
    ...
    offsetof(pb_rm_interfaces__msg__EventData, non_overlapping_supply_zone),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pb_rm_interfaces__msg__EventData, overlapping_supply_zone),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pb_rm_interfaces__msg__EventData, central_highland),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pb_rm_interfaces__msg__EventData, trapezoidal_highland),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
