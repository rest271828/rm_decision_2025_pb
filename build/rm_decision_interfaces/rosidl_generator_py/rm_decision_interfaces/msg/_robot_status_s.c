...
bool rm_decision_interfaces__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_decision_interfaces.msg._robot_status.RobotStatus", full_classname_dest, 52) == 0);
  }
  rm_decision_interfaces__msg__RobotStatus * ros_message = _ros_message;
  {  // robot_id
  ...
  {  // ammo_buy
    PyObject * field = PyObject_GetAttrString(_pymsg, "ammo_buy");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->ammo_buy = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * rm_decision_interfaces__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_decision_interfaces.msg._robot_status");
  ...
  {  // ammo_buy
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->ammo_buy);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ammo_buy", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
