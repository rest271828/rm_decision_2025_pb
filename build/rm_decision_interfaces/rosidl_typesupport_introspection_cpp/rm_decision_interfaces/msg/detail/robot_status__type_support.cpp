...
{
  new (message_memory) rm_decision_interfaces::msg::RobotStatus(_init);
}

void RobotStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_decision_interfaces::msg::RobotStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotStatus_message_member_array[4] = {
  {
    ...
    offsetof(rm_decision_interfaces::msg::RobotStatus, robot_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_decision_interfaces::msg::RobotStatus, current_hp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_decision_interfaces::msg::RobotStatus, shooter_heat),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_decision_interfaces::msg::RobotStatus, ammo_buy),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotStatus_message_members = {
  ...
  4,  // number of fields
  sizeof(rm_decision_interfaces::msg::RobotStatus),
...
get_message_type_support_handle<rm_decision_interfaces::msg::RobotStatus>()
{
  return &::rm_decision_interfaces::msg::rosidl_typesupport_introspection_cpp::RobotStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_decision_interfaces, msg, RobotStatus)() {
  return &::rm_decision_interfaces::msg::rosidl_typesupport_introspection_cpp::RobotStatus_message_type_support_handle;
}
