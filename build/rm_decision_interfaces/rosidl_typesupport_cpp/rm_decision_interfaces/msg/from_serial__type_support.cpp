...
static const _FromSerial_type_support_symbol_names_t _FromSerial_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_decision_interfaces, msg, FromSerial)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_decision_interfaces, msg, FromSerial)),
  }
};
...
{
  return &::rm_decision_interfaces::msg::rosidl_typesupport_cpp::FromSerial_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_decision_interfaces, msg, FromSerial)() {
  return get_message_type_support_handle<rm_decision_interfaces::msg::FromSerial>();
}
