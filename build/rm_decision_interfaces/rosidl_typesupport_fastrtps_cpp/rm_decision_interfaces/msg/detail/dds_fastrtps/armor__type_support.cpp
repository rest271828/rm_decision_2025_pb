...
#include "rm_decision_interfaces/msg/detail/armor__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_decision_interfaces::msg::Armor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_decision_interfaces::msg::Armor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_decision_interfaces::msg::Armor *>(
    untyped_ros_message);
...
{
  return &rm_decision_interfaces::msg::typesupport_fastrtps_cpp::_Armor__handle;
}
