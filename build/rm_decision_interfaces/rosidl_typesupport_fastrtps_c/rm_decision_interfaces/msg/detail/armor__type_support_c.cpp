...
#include "rm_decision_interfaces/msg/detail/armor__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_rm_decision_interfaces
...
using _Armor__ros_msg_type = rm_decision_interfaces__msg__Armor;
...
size_t get_serialized_size_rm_decision_interfaces__msg__Armor(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Armor__ros_msg_type * ros_message = static_cast<const _Armor__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Armor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_decision_interfaces__msg__Armor(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
size_t max_serialized_size_rm_decision_interfaces__msg__Armor(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_decision_interfaces__msg__Armor;
    is_plain =
      (
...
static size_t _Armor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_decision_interfaces__msg__Armor(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_decision_interfaces, msg, Armor)() {
