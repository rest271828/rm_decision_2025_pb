...
{
public:
  explicit Init_SendSerial_distance(::auto_aim_interfaces::msg::SendSerial & msg)
  : msg_(msg)
  {}
  ::auto_aim_interfaces::msg::SendSerial distance(::auto_aim_interfaces::msg::SendSerial::_distance_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_SendSerial_distance pitch(::auto_aim_interfaces::msg::SendSerial::_pitch_type arg)
  {
...
class Init_SendSerial_bigyaw
{
public:
  explicit Init_SendSerial_bigyaw(::auto_aim_interfaces::msg::SendSerial & msg)
  : msg_(msg)
  {}
  Init_SendSerial_yaw bigyaw(::auto_aim_interfaces::msg::SendSerial::_bigyaw_type arg)
  {
    msg_.bigyaw = std::move(arg);
...
{
public:
  explicit Init_SendSerial_is_can_hit(::auto_aim_interfaces::msg::SendSerial & msg)
  : msg_(msg)
  {}
  Init_SendSerial_bigyaw is_can_hit(::auto_aim_interfaces::msg::SendSerial::_is_can_hit_type arg)
  {
    msg_.is_can_hit = std::move(arg);
    return Init_SendSerial_bigyaw(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_SendSerial_is_can_hit is_tracking(::auto_aim_interfaces::msg::SendSerial::_is_tracking_type arg)
  {
