...
#include "auto_aim_interfaces/msg/detail/receive_serial__rosidl_typesupport_fastrtps_c.h"
...
using _ReceiveSerial__ros_msg_type = auto_aim_interfaces__msg__ReceiveSerial;
...
size_t get_serialized_size_auto_aim_interfaces__msg__ReceiveSerial(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ReceiveSerial__ros_msg_type * ros_message = static_cast<const _ReceiveSerial__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ReceiveSerial__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__ReceiveSerial(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_aim_interfaces
size_t max_serialized_size_auto_aim_interfaces__msg__ReceiveSerial(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__ReceiveSerial;
    is_plain =
      (
...
static size_t _ReceiveSerial__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__ReceiveSerial(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, ReceiveSerial)() {
