...
#include "auto_aim_interfaces/msg/detail/send_serial__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const auto_aim_interfaces::msg::SendSerial & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auto_aim_interfaces::msg::SendSerial & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces::msg::SendSerial;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::SendSerial *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auto_aim_interfaces::msg::SendSerial *>(
    untyped_ros_message);
...
{
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_SendSerial__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auto_aim_interfaces, msg, SendSerial)() {
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_SendSerial__handle;
}
