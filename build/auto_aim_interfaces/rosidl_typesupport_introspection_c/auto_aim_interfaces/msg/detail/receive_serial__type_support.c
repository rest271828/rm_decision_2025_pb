...
static rosidl_typesupport_introspection_c__MessageMember auto_aim_interfaces__msg__ReceiveSerial__rosidl_typesupport_introspection_c__ReceiveSerial_message_member_array[3] = {
  {
    "header",  // name
