...
bool iw_interfaces__msg__area__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("iw_interfaces.msg._area.Area", full_classname_dest, 28) == 0);
  }
  iw_interfaces__msg__Area * ros_message = _ros_message;
  {  // label
...
PyObject * iw_interfaces__msg__area__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("iw_interfaces.msg._area");
