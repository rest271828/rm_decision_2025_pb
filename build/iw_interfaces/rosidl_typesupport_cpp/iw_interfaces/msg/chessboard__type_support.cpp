...
static const _Chessboard_type_support_symbol_names_t _Chessboard_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, iw_interfaces, msg, Chessboard)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, iw_interfaces, msg, Chessboard)),
  }
};
...
{
  return &::iw_interfaces::msg::rosidl_typesupport_cpp::Chessboard_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, iw_interfaces, msg, Chessboard)() {
  return get_message_type_support_handle<iw_interfaces::msg::Chessboard>();
}
