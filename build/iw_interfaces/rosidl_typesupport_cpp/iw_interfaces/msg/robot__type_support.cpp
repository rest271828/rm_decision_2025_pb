...
static const _Robot_type_support_symbol_names_t _Robot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, iw_interfaces, msg, Robot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, iw_interfaces, msg, Robot)),
  }
};
...
{
  return &::iw_interfaces::msg::rosidl_typesupport_cpp::Robot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, iw_interfaces, msg, Robot)() {
  return get_message_type_support_handle<iw_interfaces::msg::Robot>();
}
