...
#include "iw_interfaces/msg/detail/area__rosidl_typesupport_fastrtps_c.h"
...
using _Area__ros_msg_type = iw_interfaces__msg__Area;
...
size_t get_serialized_size_iw_interfaces__msg__Area(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Area__ros_msg_type * ros_message = static_cast<const _Area__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Area__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_iw_interfaces__msg__Area(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_iw_interfaces
size_t max_serialized_size_iw_interfaces__msg__Area(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = iw_interfaces__msg__Area;
    is_plain =
      (
...
static size_t _Area__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_iw_interfaces__msg__Area(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, iw_interfaces, msg, Area)() {
