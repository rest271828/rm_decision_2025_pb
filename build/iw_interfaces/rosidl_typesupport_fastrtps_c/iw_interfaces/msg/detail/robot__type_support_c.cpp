...
#include "iw_interfaces/msg/detail/robot__rosidl_typesupport_fastrtps_c.h"
...
using _Robot__ros_msg_type = iw_interfaces__msg__Robot;
...
static uint32_t _Robot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_iw_interfaces__msg__Robot(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = iw_interfaces__msg__Robot;
    is_plain =
      (
...
static size_t _Robot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_iw_interfaces__msg__Robot(
