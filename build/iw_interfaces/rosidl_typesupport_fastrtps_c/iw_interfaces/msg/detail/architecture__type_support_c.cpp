...
#include "iw_interfaces/msg/detail/architecture__rosidl_typesupport_fastrtps_c.h"
...
using _Architecture__ros_msg_type = iw_interfaces__msg__Architecture;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Architecture__ros_msg_type * ros_message = static_cast<const _Architecture__ros_msg_type *>(untyped_ros_message);
  // Field name: label
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Architecture__ros_msg_type * ros_message = static_cast<_Architecture__ros_msg_type *>(untyped_ros_message);
  // Field name: label
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _Architecture__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_iw_interfaces__msg__Architecture(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = iw_interfaces__msg__Architecture;
    is_plain =
      (
...
static size_t _Architecture__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_iw_interfaces__msg__Architecture(
...
static message_type_support_callbacks_t __callbacks_Architecture = {
  "iw_interfaces::msg",
  "Architecture",
