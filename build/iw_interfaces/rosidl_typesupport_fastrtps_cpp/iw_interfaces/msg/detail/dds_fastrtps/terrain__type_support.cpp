...
#include "iw_interfaces/msg/detail/terrain__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const iw_interfaces::msg::Terrain & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  iw_interfaces::msg::Terrain & ros_message)
{
  // Member: label
  cdr >> ros_message.label;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = iw_interfaces::msg::Terrain;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const iw_interfaces::msg::Terrain *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<iw_interfaces::msg::Terrain *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Terrain__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const iw_interfaces::msg::Terrain *>(
...
static size_t _Terrain__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Terrain(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Terrain__callbacks = {
  "iw_interfaces::msg",
  "Terrain",
...
static rosidl_message_type_support_t _Terrain__handle = {
...
{
  return &iw_interfaces::msg::typesupport_fastrtps_cpp::_Terrain__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, iw_interfaces, msg, Terrain)() {
  return &iw_interfaces::msg::typesupport_fastrtps_cpp::_Terrain__handle;
}
