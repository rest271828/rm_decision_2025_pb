...
#include "iw_interfaces/msg/detail/area__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const iw_interfaces::msg::Area & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  iw_interfaces::msg::Area & ros_message)
{
  // Member: label
  cdr >> ros_message.label;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = iw_interfaces::msg::Area;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const iw_interfaces::msg::Area *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<iw_interfaces::msg::Area *>(
    untyped_ros_message);
...
{
  return &iw_interfaces::msg::typesupport_fastrtps_cpp::_Area__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, iw_interfaces, msg, Area)() {
  return &iw_interfaces::msg::typesupport_fastrtps_cpp::_Area__handle;
}
