...
#include "iw_interfaces/msg/detail/chessboard__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const iw_interfaces::msg::Terrain &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  iw_interfaces::msg::Terrain &);
size_t get_serialized_size(
  const iw_interfaces::msg::Terrain &,
  size_t current_alignment);
size_t
max_serialized_size_Terrain(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
{
bool cdr_serialize(
  const iw_interfaces::msg::Architecture &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const iw_interfaces::msg::Chessboard & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  iw_interfaces::msg::Chessboard & ros_message)
{
  // Member: faction
  cdr >> ros_message.faction;
  ...
  // Member: terrains
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.terrains.resize(size);
    for (size_t i = 0; i < size; i++) {
      iw_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.terrains[i]);
    }
  }
  ...
  // Member: architectures
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.architectures.resize(size);
    for (size_t i = 0; i < size; i++) {
      iw_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.architectures[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: terrains
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        iw_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.terrains[index], current_alignment);
    }
  }
  // Member: architectures
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        iw_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.architectures[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_iw_interfaces
max_serialized_size_Chessboard(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: robots
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        iw_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Robot(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: terrains
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        iw_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Terrain(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: architectures
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        iw_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Architecture(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = iw_interfaces::msg::Chessboard;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const iw_interfaces::msg::Chessboard *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<iw_interfaces::msg::Chessboard *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Chessboard__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const iw_interfaces::msg::Chessboard *>(
...
static size_t _Chessboard__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Chessboard(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Chessboard__callbacks = {
  "iw_interfaces::msg",
  "Chessboard",
...
static rosidl_message_type_support_t _Chessboard__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Chessboard__callbacks,
...
{
  return &iw_interfaces::msg::typesupport_fastrtps_cpp::_Chessboard__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, iw_interfaces, msg, Chessboard)() {
  return &iw_interfaces::msg::typesupport_fastrtps_cpp::_Chessboard__handle;
}
