...
#include "pb_rm_interfaces/msg/detail/gimbal_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const pb_rm_interfaces::msg::Gimbal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
// functions for pb_rm_interfaces::msg::Gimbal already declared above
...
cdr_serialize(
  const pb_rm_interfaces::msg::GimbalCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pb_rm_interfaces::msg::GimbalCmd & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: position
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        pb_rm_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Gimbal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = pb_rm_interfaces::msg::GimbalCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pb_rm_interfaces::msg::GimbalCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pb_rm_interfaces::msg::GimbalCmd *>(
    untyped_ros_message);
...
{
  return &pb_rm_interfaces::msg::typesupport_fastrtps_cpp::_GimbalCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pb_rm_interfaces, msg, GimbalCmd)() {
  return &pb_rm_interfaces::msg::typesupport_fastrtps_cpp::_GimbalCmd__handle;
}
