...
bool pb_rm_interfaces__msg__buff__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pb_rm_interfaces.msg._buff.Buff", full_classname_dest, 31) == 0);
  }
  pb_rm_interfaces__msg__Buff * ros_message = _ros_message;
  {  // recovery_buff
...
PyObject * pb_rm_interfaces__msg__buff__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pb_rm_interfaces.msg._buff");
