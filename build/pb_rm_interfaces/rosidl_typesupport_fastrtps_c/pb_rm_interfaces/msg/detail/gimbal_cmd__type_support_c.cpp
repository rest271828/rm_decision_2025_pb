...
#include "pb_rm_interfaces/msg/detail/gimbal_cmd__rosidl_typesupport_fastrtps_c.h"
...
#include "pb_rm_interfaces/msg/detail/gimbal__functions.h"  // position, velocity
...
using _GimbalCmd__ros_msg_type = pb_rm_interfaces__msg__GimbalCmd;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: position
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, pb_rm_interfaces, msg, Gimbal
      )()->data);
    if (!callbacks->cdr_serialize(
...
size_t get_serialized_size_pb_rm_interfaces__msg__GimbalCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GimbalCmd__ros_msg_type * ros_message = static_cast<const _GimbalCmd__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_pb_rm_interfaces__msg__Gimbal(
...
static uint32_t _GimbalCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pb_rm_interfaces__msg__GimbalCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pb_rm_interfaces
size_t max_serialized_size_pb_rm_interfaces__msg__GimbalCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: position
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_pb_rm_interfaces__msg__Gimbal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = pb_rm_interfaces__msg__GimbalCmd;
    is_plain =
      (
...
static size_t _GimbalCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pb_rm_interfaces__msg__GimbalCmd(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pb_rm_interfaces, msg, GimbalCmd)() {
