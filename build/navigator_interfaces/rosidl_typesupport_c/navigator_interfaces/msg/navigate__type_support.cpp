...
static const _Navigate_type_support_symbol_names_t _Navigate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, navigator_interfaces, msg, Navigate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, navigator_interfaces, msg, Navigate)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, navigator_interfaces, msg, Navigate)() {
  return &::navigator_interfaces::msg::rosidl_typesupport_c::Navigate_message_type_support_handle;
}
